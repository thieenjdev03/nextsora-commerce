      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="flex justify-between items-center mb-8">
          <div>
            ...
            <p className="text-gray-600 mt-2">
              Manage your NextSora account and explore our features
            </p>
          </div>
          <Button 
        ...
        <div className="grid md:grid-cols-3 gap-6">
          ...
          <div className="bg-white rounded-lg shadow-sm border p-6">
            ...
            <p className="text-gray-600 mb-4">View your usage statistics and insights</p>
            <Button variant="outline" className="w-full">
              View Analytics
            </Button>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-sm border p-6">
            ...
            <p className="text-gray-600 mb-4">Configure your account settings and security</p>
            <Button variant="outline" className="w-full">
              Open Settings
            </Button>
          </div>
        ...
        <div className="mt-8 bg-white rounded-lg shadow-sm border p-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <a href="http://localhost:3003/login" target="_blank" rel="noopener noreferrer">
